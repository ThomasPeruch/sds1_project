package com.tproject.dspesquisa.resources;
...
import com.tproject.dspesquisa.services.RecordService;
...
public class RecordResource {
	...
	public ResponseEntity<Page<RecordDTO>> findAll(
		...
		Page <RecordDTO> list = service.findByMoments(minDate, maxDate, pgRequest);
